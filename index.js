...
const peerDelivery = createRoomDelivery({
  isBusy: sessionOccupiedForRoomDelivery,
  // Untrusted-provenance handling is layered: formatPeerDelivery marks this
  // ordinary role:'user' turn as hostile-by-default, while the deployment-conditional downstream
  ...
  req.on('end', async () => {
    ...
    try {
      ...
      if (url.pathname === '/agent-message') {
        ...
        // Accepted v1 residual: callerSession
