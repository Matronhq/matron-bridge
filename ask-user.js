...
server.tool(
  'agent_sessions',
  "List this user's addressable agent sessions for direct coordination. Each entry includes its conversation id, title, state, and whether it is this session; never target an entry where is_self is true.",
  {},
  async () => {
    try {
