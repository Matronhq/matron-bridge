...
//
// Modeled on subagent-running-store.js's on-disk handling, factored into a shared core so a second
// store (run-state-outbox.js) does not hand-copy it. The subtlety here is not the JSON; it is the
// failure states, and having two hand-copied versions of them means a fix to one silently leaves
// the other broken.
//
// READ STATES:
