...
// we spawn it in a PTY. Two distinct things get primed:
//
...
//      the same line as the heading and gets misclassified. Easier to skip
//      it entirely.
export function ensureWorkspaceTrusted(workdir, claudeJsonPath = DEFAULT_PATH) {
  ...
  if (projectAlreadyPrimed && globalAlreadyPrimed) {
    return;
  }
