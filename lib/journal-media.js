...
// How a voice note's transcript is packaged for the agent. Exported because
// index.js has to take it back OFF again when the queued transcript is filed
// as a tracker task ("📌 Make task"): the label is transport packaging, not
// part of what the user said, and it would otherwise be the whole task title.
