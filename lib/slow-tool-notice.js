...
// notice when a tool call crosses the threshold (3 min), one reminder if it
...
// timings nagged on ordinary builds and test runs; a call has to be genuinely
// long before anyone wants to hear about it.
//
// Scope decisions:
...
export const DEFAULT_SLOW_TOOL_NOTICE_MS = 180_000;
