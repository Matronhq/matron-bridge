...
//   design. Task is excluded because subagents surface their own progress
//   and routinely run long on purpose.
...
const EXCLUDED_TOOLS = new Set(['AskUserQuestion', 'ExitPlanMode', 'EnterPlanMode', 'Task']);
