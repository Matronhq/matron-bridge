...
export function createRpcRequestHandler({
  ...
  // edit_file is registered only when this is true; otherwise the method is
  // absent and a caller gets unknown_method, same as from an older bridge.
  ...
  if (!fileEditEnabled) delete handlers.edit_file;
