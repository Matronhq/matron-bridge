...
// a reorder, a field edit or a malformed marker must never respawn a session
// for a turn that would then be thrown away. Also checked here before any I/O,
// so such a marker costs no blob fetch and no journal round trip.
