...
export const BRIDGE_COMMAND_NAMES = new Set([
  ...
  'agent', 'mcp', 'model', 'mode', 'effort', 'cost', 'usage', 'limits', 'tools',
]);
...
export const JOURNAL_CONTROL_HELP_NOTE =
  ...
  '- Session-scoped commands (/status, /stop, /restart, /show, /working, /agent, /mcp, /model, /mode, /effort, /cost, /usage, /tools) ' +
